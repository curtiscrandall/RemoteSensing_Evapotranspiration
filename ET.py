...
def etProcessing(station, year, month, day):
    ...
    newFile    = "D:\GIS_Data\Thesis\Scripts\Rasters\et{}{}.tif" .format(month, day)
    ...
    # Add stats fromm all stations; maybe use mean of the 3
    # -----------------------------------------------------------------------------------------------------
    ...
    if station == "Boise":
        ...
        url = "https://www.usbr.gov/pn-bin/daily.pl?station=BOII&year=%s&month=%s&day=%s&year=%s&month=%s&day=%s&pcode=ETOS&pcode=MN&pcode=MX&pcode=MM&pcode=SR&pcode=TA&pcode=YM&pcode=UA" % (year, month, day, year, month, day)
        # table from website
    ...
    # ETcc = ccGrass*AgMet_KM
    ETdc = dcGrass*AgMet_KM
    ...
    # Calibration
    pixel = eviBoise
    c = 0.49  # fitting coefficient 0.49 BOII
    b = 1.48  # fitting coefficient 1.48
    ETboii = ETrs * b * (1. - np.exp((-2.25) * pixel)) - c
    # Correct to match dual crop coefficient
    # c = ETboii - ETdc  # fitting coefficient
    # ETboii = AgMet_KM * b * (1. - np.exp((-2.25) * pixel)) - c
    
    # Difference of Eta and Model ETa
    # print('Alfalfa Reference ET: %.2f' % ETrs)
    # print('Grass ETa: %.2f' % ETdc)
    print('%.2f' % (ETboii))  # just print ref and act et for station for excel import
...
site       = "Boise"
etOutput   = []
# Process Each Image using the et function
et01 = etProcessing(site, "2017", "04", "04")
etOutput.append(et01)
et02 = etProcessing(site, "2017", "05", "04")
etOutput.append(et02)
et03 = etProcessing(site, "2017", "05", "27")
etOutput.append(et03)
et04 = etProcessing(site, "2017", "06", "23")
etOutput.append(et04)
et05 = etProcessing(site, "2017", "06", "26")
etOutput.append(et05)
et06 = etProcessing(site, "2017", "07", "03")
etOutput.append(et06)
et07 = etProcessing(site, "2017", "07", "06")
etOutput.append(et07)
et08 = etProcessing(site, "2017", "07", "13")
etOutput.append(et08)
et09 = etProcessing(site, "2017", "07", "16")
etOutput.append(et09)
et10 = etProcessing(site, "2017", "07", "23")
etOutput.append(et10)
et11 = etProcessing(site, "2017", "07", "26")
etOutput.append(et11)
et12 = etProcessing(site, "2017", "08", "02")
etOutput.append(et12)
et13 = etProcessing(site, "2017", "08", "05")
etOutput.append(et13)
et14 = etProcessing(site, "2017", "08", "12")
etOutput.append(et14)
et15 = etProcessing(site, "2017", "08", "15")
etOutput.append(et15)
et16 = etProcessing(site, "2017", "08", "22")
etOutput.append(et16)
et17 = etProcessing(site, "2017", "08", "25")
etOutput.append(et17)
et18 = etProcessing(site, "2017", "09", "01")
etOutput.append(et18)
et19 = etProcessing(site, "2017", "09", "11")
etOutput.append(et19)
...
import pandas as pd
df = pd.DataFrame(etOutput, columns=["ETr/Model", "Model-ETr", "coef", "ETboii", "AgMet_KM", "station"])
...
etDiff    = [et01[0], et02[0], et03[0], et04[0], et05[0], et06[0], et07[0], et08[0], et09[0], et10[0], et11[0], et12[0], et13[0], et14[0], et15[0], et16[0], et17[0], et18[0], et19[0], et20[0], et21[0], et22[0]]
etSTD     = [et01[1], et02[1], et03[1], et04[1], et05[1], et06[1], et07[1], et08[1], et09[1], et10[1], et11[1], et12[1], et13[1], et14[1], et15[1], et16[1], et17[1], et18[1], et19[1], et20[1], et21[1], et22[1]]
etC       = [et01[2], et02[2], et03[2], et04[2], et05[2], et06[2], et07[2], et08[2], et09[2], et10[2], et11[2], et12[2], et13[2], et14[2], et15[2], et16[2], et17[2], et18[2], et19[2], et20[2], et21[2], et22[2]]
etEviSTD  = [et01[4], et02[4], et03[4], et04[4], et05[4], et06[4], et07[4], et08[4], et09[4], et10[4], et11[4], et12[4], et13[4], et14[4], et15[4], et16[4], et17[4], et18[4], et19[4], et20[4], et21[4], et22[4]]
